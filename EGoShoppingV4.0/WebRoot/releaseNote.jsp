	...
	<div id="page">
		...
		<div class="wrapper">
				...
				<section class="column width6 first">			
						...
						<fieldset>
								<p>
									<label for="input2">标题：</label><br/>
									<input type="text" id="input2" class="half title" value="" name="title"/>
								</p>
						</fieldset>
						
						<fieldset>
							<p>
								<label for="area1">内容：</label><br/>
								<textarea id="area2" class="medium half" name="noteContent"></textarea>
							</p>
						</fieldset>
						<%=request.getAttribute("message") == null ? "" : request
					.getAttribute("message")%>
						<fieldset>
							<p class=""><input type="submit" class="btn btn-green big" value="提交"/></p>
						</fieldset>
