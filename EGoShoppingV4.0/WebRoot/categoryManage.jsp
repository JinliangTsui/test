<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" import="com.ego.service.SecondCategoryService"
		...
		<div class="wrapper">
			...
			<table class="display stylized" id="example">
				...
				<tbody>
					...
					%>
					<tr class="gradeX">
						<td><%=scv.getSecCategoryId()%></td>
						<td><%=scv.getSecCategoryDesc()%></td>
						<td><%=scv.getCategoryDesc()%></td>
						<td class="center"><a
							href="delSecondCategory?id=<%=scv.getSecCategoryId()%>">删除</a>| <a
							href="modSecCategory.jsp?id=<%=scv.getSecCategoryId()%>">修改</a>
						</td>
					</tr>
					<%
						}
